      ...
      <Container sx={{ marginTop: "2rem", marginBottom: "10rem" }}>
        <>
          <Typography className="promotor-title">
            ...
            <br /> {t("promotor.biorhiza-subtitle")}
          </Typography>
            ...
            >
              <Typography
                ...
                dangerouslySetInnerHTML={{
                  __html: t("promotor.biorhiza-text"),
                }}
              />
              <Typography
                className="promotor-text"
                dangerouslySetInnerHTML={{
                  __html: t("promotor.biorhiza-text-2"),
                }}
              />
            </Box>
          </Box>
          ...
          <Typography
            ...
            dangerouslySetInnerHTML={{
              ...
              <ul>
                <li>${t("promotor.biorhiza-1-list")}</li>
                <li>${t("promotor.biorhiza-2-list")}</li>
                <li>${t("promotor.biorhiza-3-list")}</li>
                <li>${t("promotor.biorhiza-4-list")}</li>
                <li>${t("promotor.biorhiza-5-list")}</li> 
              </ul>
            `,
            }}
          />
